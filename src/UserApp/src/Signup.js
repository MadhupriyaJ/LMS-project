  ...
  return (
    <div className="modal_full">
      ...
      <div className="modal_body">
        <label className="modal_email">New Email</label>
        <input
        ...
        <label className="modal_password">New Password</label>
        ...
        <input
          ...
          id="si_popup_passwd"
          onfocus="this.placeholder = 'Enter your new Password'"
        ...
        <p class="terms-conditions-privacy">
          <span class="note">Please Note: </span>By continuing and signing up,
        ...
        <button className="modal_loginbutton"type="submit" onClick={register}>Sign Up</button>
        <p className="modal_dontaccount">
          Already have an account?{" "}
          <Link to="/">
            <span class="login-vd">Log In</span>
          </Link>
        </p>
      </div>
    </div>
