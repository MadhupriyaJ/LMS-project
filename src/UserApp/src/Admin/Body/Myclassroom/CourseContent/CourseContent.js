...
const handleSubmit = (e) => {
  ...
  return (
    <>
          ...
          <div class="tab-content">
            ...
            <Stack spacing={2} sx={{width: "100%", marginTop: "20px", marginLeft: "100px",}}>
              <Pagination count={paginationCount} color="primary" renderItem={(item) => (
                  <PaginationItem component={Link} to={`${location.pathname.startsWith('/homepage') ? '/homepage' : '/admin_homepage'}/my-classroom/coursecontent/page/${item.page}/${coursename}`} {...item}/>)}
        ...
        return (
          pathname.slice(sliceStart, sliceEnd) === course.ChapterID && (
            <div className="coursecontmain" key={course.ChapterID}>
              <a
                href={`${location.pathname.startsWith("/homepage") ? "/homepage" : "/admin_homepage"}/view-recording/page/${sliceValue}/${coursename}`} className="courseconttile"
              >
     ...
     {location.pathname.startsWith('/admin_homepage') && (
