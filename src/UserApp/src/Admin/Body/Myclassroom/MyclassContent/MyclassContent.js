    ...
    <div class="col-lg-2 col-md-2 col-sm-3 col-xs-3 no-padding left-nav-curriculum">
      ...
      <ul class="nav nav-tabs nav-stacked curriculumleftnav" role="tablist">
        <li routerlinkactive="active" id="Getting Started" class="linkclass">
          <a class = 'taga' data-toggle="tab" role="tab" href={`${location.pathname.startsWith('/homepage') ? '/homepage' : '/user_homepage'}/my-classroom/gettingstarted/${coursename}`}> {/* {`user_homepage/my-classroom/gettingstarted/${course.coursename}`} */}
          {/* {`${location.pathname.startsWith('/homepage') ? '/homepage' : '/user_homepage'}/my-classroom/gettingstarted/${coursename}`} */}
          <PowerSettingsNewIcon /> Getting Started</a>
          
        </li>
        <li routerlinkactive="active" id="Course Content" class="linkclass">
          <a class = 'taga' data-toggle="tab" role="tab" href= {`${location.pathname.startsWith('/homepage') ? '/homepage' : '/user_homepage'}/my-classroom/coursecontent/page/1/${coursename}`}> {/* {`user_homepage/my-classroom/coursecontent/page/:page/${course.coursename}`} */}
            {/* {`${location.pathname.startsWith('/homepage') ? '/homepage' : '/user_homepage'}/my-classroom/coursecontent/page/:page/${coursename}`} */}
            <ArticleIcon /> Course Content</a>
        </li>
        <li routerlinkactive="active" id="Pre-recorded Classes" class="linkclass">
          <a class = 'taga' data-toggle="tab" role="tab" href={`${location.pathname.startsWith('/homepage') ? '/homepage' : '/user_homepage'}/my-classroom/LiveSession/${coursename}`}>
           {/* {`${location.pathname.startsWith('/homepage') ? '/homepage' : '/user_homepage'}/my-classroom/LiveSession/page/:page/${coursename}`} */}
